...
function getWelcomeResponse(callback) {
    var sessionAttributes = {},
        speechOutput = "Let's test you on baby animal names. I will ask you about " + GAME_LENGTH.toString()
            + " animals, try to get as many right as you can. Just say the name of the baby name. Let's begin.",
...
function handleAnswerRequest(intent, session, callback) {
    ...
    if (!gameInProgress) {
        ...
        var speechOutput = "Your answer must be a name " + reprompt;
        ...
        if (currentQuestionIndex == GAME_LENGTH - 1) {
            ...
            speechOutput += speechOutputAnalysis + "You got " + currentScore.toString() + " out of "
                + GAME_LENGTH.toString() + " questions correct. Thank you for playing baby animal names with Alexa!";
            callback(session.attributes,
...
function handleGetHelpRequest(intent, session, callback) {
    ...
    var speechOutput = "I will ask you to provide an animal, you will need to provide the baby name. "
        + "To start a new game at any time, say, start new game. "
        + "To repeat the last animal, say, repeat. "
        + "Would you like to keep playing?",
        repromptText = "To give an answer, respond with the correct baby name. "
        + "Would you like to keep playing?";
